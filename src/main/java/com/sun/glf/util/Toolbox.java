...
public class Toolbox {
  ...
  /**
   * @param shapes array of Shapes which should be concatenated into a single one
   * 
  ...
  /**
   * @param color color used as a base to create a transparent version. This is usefull for 
