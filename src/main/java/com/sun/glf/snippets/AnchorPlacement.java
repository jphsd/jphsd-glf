...
public class AnchorPlacement{
  public static final String USAGE = "java com.sun.glf.snippets.AnchorPlacement <backgroundImage>";
  ...
  public static void main(String args[]){
    ...
    for(int i=0; i<n; i++){
      Position position = new Position(anchors[i]);      // Create new Position.
