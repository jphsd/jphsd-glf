...
public class GetSpotLightUsage implements CompositionFactory{
  ...
  public Composition build(){
    ...
    Dimension spotSize = new Dimension(2*width, 2*height);
	...
	= new LitSurface(0, 
      ...
      SpotLight light = LightsStudio.getSpotLight(litRect, anchors[i], spotSize, lightIntensity, lightColor);
      texturedSurface.addLight(light);
