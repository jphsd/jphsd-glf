...
public class GetHotSpotLightRampUsage implements CompositionFactory{
  int width = 250;
  ...
  public Composition build(){
    ...
    LitSurface texturedSurface 
      ...
      SpotLight lights[] = LightsStudio.getHotSpotLightRamp(litRect,
							    i+2,
							    anchors[i], 
							    lightIntensity,
							    lightColor,
