...
import com.sun.glf.goodies.ControlStroke;
 ...
 * @version        1.0
 */
public class ControlStrokeUsage extends JComponent{
  private GeneralPath eiffel = new GeneralPath(); 
  private int scale = 3;
  private float strokeWidth = 1.5f/scale;
  private int margins = 20;

  public ControlStrokeUsage(){
    ...
    int width = (int)(bounds.width + 20 + strokeWidth*2 + margins*2);
    int height = (int)(bounds.height + 20 + strokeWidth*2 + margins*2);
  ...
  public void paint(Graphics _g){
    ...
    ControlStroke controlStroke = new ControlStroke(strokeWidth);
  ...
  public static void main(String args[]){
    new SnippetFrame(new ControlStrokeUsage());
  }
}
