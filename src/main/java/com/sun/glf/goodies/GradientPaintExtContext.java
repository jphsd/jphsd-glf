...
class GradientPaintExtContext implements PaintContext {
  ...
  public static void main(String args[]){
    ...
    float I[] = {1};
    GradientPaintExt paint = new GradientPaintExt(new Point(0, 0), new Point(100, 100), I, colors);
    
    LayerComposition cmp = new LayerComposition(new Dimension(100, 100));
    ShapeLayer layer = new ShapeLayer(cmp, cmp.getBounds(), new FillRenderer(paint));
